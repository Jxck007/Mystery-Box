  ...
  useEffect(() => {
    ...
    const beginPlayback = async () => {
      try {
        ...
        // Keep default start if seeking is not allowed.
      }
          ...
          {showTitleOverlay && gameTitle && (
            ...
            >
              <div className="bg-white text-black px-6 py-4 md:px-10 md:py-6 rounded-2xl max-w-[80%] text-center border-[3px] border-black shadow-[6px_6px_0px_rgba(0,0,0,1)]">
                <h1 className="font-black text-4xl md:text-5xl uppercase tracking-tight" style={{ fontFamily: "Impact, system-ui, sans-serif", letterSpacing: "-0.05em" }}>
                  {gameTitle}
                </h1>
              </div>
            </motion.div>
            ...
            {showTitleOverlay && gameTitle && (
              ...
              >
                <div className="bg-white text-black drop-shadow-2xl px-12 py-8 rounded-2xl max-w-2xl text-center flex flex-col items-center justify-center border-4 border-black shadow-[10px_10px_0px_rgba(0,0,0,1)]">
                  <h1 className="font-black text-6xl md:text-8xl uppercase tracking-tighter" style={{ fontFamily: "Impact, system-ui, sans-serif", letterSpacing: "-0.05em" }}>
                    {gameTitle}
                  </h1>
                </div>
              </motion.div>
