...
export function MysteryBox({ disabled, isClicked, onOpen }: MysteryBoxProps) {
  return (
    <div className="relative mx-auto flex min-h-[240px] w-full max-w-md items-center justify-center">
      ...
      <motion.button
        ...
        disabled={disabled}
        onClick={onOpen}
        className="relative h-44 w-44 rounded-3xl border border-cyan-200/70 bg-[linear-gradient(180deg,#09253c_0%,#0d3854_40%,#071b2b_100%)] shadow-[0_0_40px_rgba(50,210,255,0.28)]"
        initial={false}
